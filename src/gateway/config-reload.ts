...
import type { AeonSageConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: AeonSageConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: AeonSageConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: AeonSageConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: AeonSageConfig) => void;
  log: {
