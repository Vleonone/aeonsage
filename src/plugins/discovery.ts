...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @aeonsage/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageAeonSage: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoverAeonSagePlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExt = path.join(workspaceRoot, ".aeonsage", "extensions");
    discoverInDirectory({
      dir: workspaceExt,
      origin: "workspace",
