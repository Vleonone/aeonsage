...
const DEFAULT_SLOT_BY_KEY: Record<PluginSlotKey, string | null> = {
  memory: null, // No default memory plugin - must be explicitly configured
};
...
export function defaultSlotIdForKey(slotKey: PluginSlotKey): string | null {
