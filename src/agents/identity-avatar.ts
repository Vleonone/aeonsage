...
function resolveAvatarSource(cfg: AeonSageConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AeonSageConfig, agentId: string): AgentAvatarResolution {
