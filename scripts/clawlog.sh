...
show_usage() {
    cat << EOF
clawlog - AeonSage Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View AeonSage logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    AeonSage logs flow through the macOS unified log (subsystem: com.aeonsage).
