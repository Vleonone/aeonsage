...
export function listChannelMessageActions(cfg: AeonSageConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: AeonSageConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: AeonSageConfig): boolean {
  for (const plugin of listChannelPlugins()) {
