...
export const PLUGIN_MANIFEST_FILENAME = "aeonsage.plugin.json";
...
// package.json "aeonsage" metadata (used for onboarding/catalog)
...
export type AeonSagePackageManifest = {
  extensions?: string[];
...
): AeonSagePackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.aeonsage ?? manifest[LEGACY_MANIFEST_KEY];
}
