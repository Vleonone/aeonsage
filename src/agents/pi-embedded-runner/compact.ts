...
import { resolveAeonSageDocsPath } from "../docs-path.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  const agentDir = params.agentDir ?? resolveAeonSageAgentDir();
  await ensureAeonSageModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createAeonSageCodingTools({
      exec: {
    ...
    const docsPath = await resolveAeonSageDocsPath({
      workspaceDir: effectiveWorkspace,
