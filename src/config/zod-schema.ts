  ...
  .object({
          ...
          .record(
            ...
            z
              .object({
                ...
                cdpUrl: z.string().optional(),
                driver: z.union([z.literal("aeonsage"), z.literal("extension")]).optional(),
    ...
    ui: z
      .object({
        ...
        fallbackLocale: z.enum(["en", "zh-CN"]).optional(),
        assistant: z
          .object({
    ...
    gateway: z
      .object({
        port: z.number().int().positive().optional(),
        securityMode: z.union([z.literal("secure"), z.literal("efficient")]).optional(),
