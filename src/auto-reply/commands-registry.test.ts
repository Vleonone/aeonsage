...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@aeonsage", { botUsername: "aeonsage" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@aeonsage args", {
        botUsername: "aeonsage",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@aeonsage: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "aeonsage" })).toBe(
      "/help@otherbot",
    );
  });
