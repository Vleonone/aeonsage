...
export async function updateConfig(
  mutator: (cfg: AeonSageConfig) => AeonSageConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: AeonSageConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: AeonSageConfig): Set<string> {
