import type { ChannelOnboardingAdapter, AeonSageConfig, WizardPrompter } from "aeonsage/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.aeonsage.org/channels/mattermost",
    ].join("\n"),
