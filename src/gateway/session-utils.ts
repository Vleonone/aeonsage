...
import { type AeonSageConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: AeonSageConfig): string[] {
...
export function listAgentsForGateway(cfg: AeonSageConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AeonSageConfig): string {
...
function resolveSessionStoreAgentId(cfg: AeonSageConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: AeonSageConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: AeonSageConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: AeonSageConfig): GatewaySessionsDefaults {
