...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/aeonsage/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/aeonsage"). */
  basePath?: string;
...
export type GatewaySecurityMode = "secure" | "efficient";
...
export type GatewayConfig = {
  ...
  port?: number;
  /** Security/efficiency preset for tool defaults (see tools.* overrides). */
  securityMode?: GatewaySecurityMode;
  /**
