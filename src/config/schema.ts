...
import { AeonSageSchema } from "./zod-schema.js";
...
export type ConfigSchema = ReturnType<typeof AeonSageSchema.toJSONSchema>;
...
const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.securityMode": "Security Mode",
  "wallet.rpc.eth": "Ethereum RPC URL",
  "wallet.rpc.base": "Base RPC URL",
  "wallet.rpc.solana": "Solana RPC URL",
...
const FIELD_HELP: Record<string, string> = {
  "meta.lastTouchedVersion": "Auto-set when AeonSage writes the config.",
  ...
  "gateway.securityMode":
    "Security preset for tool defaults: secure -> tools.profile=minimal, tools.exec.security=allowlist, tools.exec.ask=on-miss; efficient -> tools.profile=full, tools.exec.security=full, tools.exec.ask=off. Explicit tools.* overrides take precedence.",
  ...
  "gateway.controlUi.basePath":
    "Optional URL prefix where the Control UI is served (e.g. /aeonsage).",
  ...
  "diagnostics.cacheTrace.filePath":
    "JSONL output path for cache trace logs (default: $AEONSAGE_STATE_DIR/logs/cache-trace.jsonl).",
  ...
  "agents.defaults.memorySearch.store.path":
    "SQLite index path (default: ~/.aeonsage/memory/{agentId}.sqlite).",
  ...
  "plugins.installs":
    "CLI-managed install metadata (used by `aeonsage plugins update` to locate install sources).",
  "plugins.installs.*.source": 'Install source ("npm", "archive", or "path").',
  "plugins.installs.*.spec": "Original npm spec used for install (if source is npm).",
  "plugins.installs.*.sourcePath": "Original archive/path used for install (if any).",
  "plugins.installs.*.installPath":
    "Resolved install directory (usually ~/.aeonsage/extensions/<id>).",
  ...
  "wallet.rpc.eth": "Ethereum RPC URL for balance lookups.",
  "wallet.rpc.base": "Base RPC URL for balance lookups.",
  "wallet.rpc.solana": "Solana RPC URL for balance lookups.",
...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "gateway.controlUi.basePath": "/aeonsage",
  "channels.mattermost.baseUrl": "https://chat.example.com",
  "agents.list[].identity.avatar": "avatars/aeonsage.png",
  "wallet.rpc.eth": "https://...",
  "wallet.rpc.base": "https://...",
  "wallet.rpc.solana": "https://...",
};
...
function buildBaseConfigSchema(): ConfigSchemaResponse {
  ...
  const schema = AeonSageSchema.toJSONSchema({
    target: "draft-07",
    unrepresentable: "any",
  });
  schema.title = "AeonSageConfig";
