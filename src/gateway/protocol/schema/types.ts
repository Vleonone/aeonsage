...
export type MarketplaceSkillsSearchParams = Static<typeof MarketplaceSkillsSearchParamsSchema>;
export type MarketplaceSkillsSearchResult = Static<typeof MarketplaceSkillsSearchResultSchema>;
export type MarketplaceSkillsStatsParams = Static<typeof MarketplaceSkillsStatsParamsSchema>;
export type MarketplaceSkillsStatsResult = Static<typeof MarketplaceSkillsStatsResultSchema>;
export type MarketplaceSkillsSyncParams = Static<typeof MarketplaceSkillsSyncParamsSchema>;
export type MarketplaceSkillsSyncResult = Static<typeof MarketplaceSkillsSyncResultSchema>;
export type MarketplaceToolsRegistryParams = Static<typeof MarketplaceToolsRegistryParamsSchema>;
export type MarketplaceToolsRegistryResult = Static<typeof MarketplaceToolsRegistryResultSchema>;
export type MarketplaceToolsSyncParams = Static<typeof MarketplaceToolsSyncParamsSchema>;
export type MarketplaceToolsSyncResult = Static<typeof MarketplaceToolsSyncResultSchema>;
export type MarketplaceSourcesListParams = Static<typeof MarketplaceSourcesListParamsSchema>;
export type MarketplaceSourcesListResult = Static<typeof MarketplaceSourcesListResultSchema>;
export type MarketplaceSource = Static<typeof MarketplaceSourceSchema>;
