...
const compiler = env.AEONSAGE_TS_COMPILER === "tsc" ? "tsc" : "tsgo";
...
const shouldBuild = () => {
  if (env.AEONSAGE_FORCE_BUILD === "1") return true;
...
const logRunner = (message) => {
  if (env.AEONSAGE_RUNNER_LOG === "0") return;
  process.stderr.write(`[aeonsage] ${message}\n`);
};
