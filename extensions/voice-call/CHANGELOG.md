...
### Changes
- Version alignment with core AeonSage release numbers.
...
### Highlights
- First public release of the @aeonsage/voice-call plugin.
...
- CLI: `aeonsage voicecall` commands (call/start/continue/speak/end/status/tail/expose).
