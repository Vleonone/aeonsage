...
import { removeAckReactionAfterReply, shouldAckReaction } from "aeonsage/plugin-sdk";
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/aeonsage") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
