...
export function applyZaiConfig(cfg: AeonSageConfig): AeonSageConfig {
...
export function applyOpenrouterProviderConfig(cfg: AeonSageConfig): AeonSageConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: AeonSageConfig): AeonSageConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: AeonSageConfig): AeonSageConfig {
...
export function applyOpenrouterConfig(cfg: AeonSageConfig): AeonSageConfig {
...
export function applyMoonshotProviderConfig(cfg: AeonSageConfig): AeonSageConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: AeonSageConfig): AeonSageConfig {
...
export function applyKimiCodeProviderConfig(cfg: AeonSageConfig): AeonSageConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: AeonSageConfig): AeonSageConfig {
...
export function applySyntheticProviderConfig(cfg: AeonSageConfig): AeonSageConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: AeonSageConfig): AeonSageConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: AeonSageConfig): AeonSageConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: AeonSageConfig): AeonSageConfig {
