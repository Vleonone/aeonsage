...
export const DEFAULT_ASSISTANT_AVATAR = "/tentacle_avatar.png";
...
declare global {
  interface Window {
    __AEONSAGE_ASSISTANT_NAME__?: string;
    __AEONSAGE_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__AEONSAGE_ASSISTANT_NAME__,
    avatar: window.__AEONSAGE_ASSISTANT_AVATAR__,
  });
}
