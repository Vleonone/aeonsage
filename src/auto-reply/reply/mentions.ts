...
function resolveMentionPatterns(cfg: AeonSageConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: AeonSageConfig | undefined, agentId?: string): RegExp[] {
