...
import type { AeonSageConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: AeonSageConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: AeonSageConfig | undefined, pathStr: string): boolean {
...
export function resolveSkillConfig(
  config: AeonSageConfig | undefined,
  skillKey: string,
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "aeonsage-bundled";
}

export function resolveBundledAllowlist(config?: AeonSageConfig): string[] | undefined {
