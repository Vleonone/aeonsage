...
- **Wake word**: Default `aeonsage` (aliases `sage`), optional `--no-wake` bypass.
...
// Package.swift
dependencies: [
    .package(url: "https://github.com/Vleonone/swabble.git", branch: "main"),
],
targets: [
...
```json
{
  ...
  "wake": {"enabled": true, "word": "aeonsage", "aliases": ["sage"]},
  "hook": {
    "command": "",
    "args": [],
