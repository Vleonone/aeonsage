...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveAeonSageAgentDir() returns mainAgentDir
    process.env.AEONSAGE_STATE_DIR = tmpDir;
    process.env.AEONSAGE_AGENT_DIR = mainAgentDir;
