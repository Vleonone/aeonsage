...
export function buildModelAliasLines(cfg?: AeonSageConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveAeonSageAgentDir();
  const authStorage = new AuthStorage(resolvedAgentDir);
