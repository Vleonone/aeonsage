...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: AeonSageConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: AeonSageConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: AeonSageConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: AeonSageConfig): void {
    this.cache.clear();
    if (cfg) this.lastConfigRef = cfg;
  }

  private resetIfConfigChanged(cfg: AeonSageConfig): void {
