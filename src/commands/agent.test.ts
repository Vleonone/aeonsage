...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "aeonsage-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<AeonSageConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<AeonSageConfig["telegram"]>>,
