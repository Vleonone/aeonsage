...
import {
  ...
  type MarketplaceSkillsSearchParams,
  MarketplaceSkillsSearchParamsSchema,
  type MarketplaceSkillsSearchResult,
  MarketplaceSkillsSearchResultSchema,
  type MarketplaceSkillsStatsParams,
  MarketplaceSkillsStatsParamsSchema,
  type MarketplaceSkillsStatsResult,
  MarketplaceSkillsStatsResultSchema,
  type MarketplaceSkillsSyncParams,
  MarketplaceSkillsSyncParamsSchema,
  type MarketplaceSkillsSyncResult,
  MarketplaceSkillsSyncResultSchema,
  type MarketplaceToolsRegistryParams,
  MarketplaceToolsRegistryParamsSchema,
  type MarketplaceToolsRegistryResult,
  MarketplaceToolsRegistryResultSchema,
  type MarketplaceToolsSyncParams,
  MarketplaceToolsSyncParamsSchema,
  type MarketplaceToolsSyncResult,
  MarketplaceToolsSyncResultSchema,
  type MarketplaceSourcesListParams,
  MarketplaceSourcesListParamsSchema,
  type MarketplaceSourcesListResult,
  MarketplaceSourcesListResultSchema,
...
export const validateMarketplaceSkillsSearchParams = ajv.compile<MarketplaceSkillsSearchParams>(
  MarketplaceSkillsSearchParamsSchema,
);
export const validateMarketplaceSkillsStatsParams = ajv.compile<MarketplaceSkillsStatsParams>(
  MarketplaceSkillsStatsParamsSchema,
);
export const validateMarketplaceSkillsSyncParams = ajv.compile<MarketplaceSkillsSyncParams>(
  MarketplaceSkillsSyncParamsSchema,
);
export const validateMarketplaceToolsRegistryParams =
  ajv.compile<MarketplaceToolsRegistryParams>(MarketplaceToolsRegistryParamsSchema);
export const validateMarketplaceToolsSyncParams = ajv.compile<MarketplaceToolsSyncParams>(
  MarketplaceToolsSyncParamsSchema,
);
export const validateMarketplaceSourcesListParams = ajv.compile<MarketplaceSourcesListParams>(
  MarketplaceSourcesListParamsSchema,
);
...
export type {
  ...
  SkillsInstallParams,
  SkillsUpdateParams,
  MarketplaceSkillsSearchParams,
  MarketplaceSkillsSearchResult,
  MarketplaceSkillsStatsParams,
  MarketplaceSkillsStatsResult,
  MarketplaceSkillsSyncParams,
  MarketplaceSkillsSyncResult,
  MarketplaceToolsRegistryParams,
  MarketplaceToolsRegistryResult,
  MarketplaceToolsSyncParams,
  MarketplaceToolsSyncResult,
  MarketplaceSourcesListParams,
  MarketplaceSourcesListResult,
  MarketplaceSource,
