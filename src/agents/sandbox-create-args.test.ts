  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "aeonsage.sandbox=1",
        "--label",
        "aeonsage.sessionKey=main",
        "--label",
        "aeonsage.createdAtMs=1700000000000",
        "--label",
        "aeonsage.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
