...
export const A2UI_PATH = "/__aeonsage__/a2ui";
export const CANVAS_HOST_PATH = "/__aeonsage__/canvas";
export const CANVAS_WS_PATH = "/__aeonsage/ws";
...
(() => {
  ...
  const handlerNames = ["aeonsageCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.AeonSage = globalThis.AeonSage ?? {};
  globalThis.AeonSage.postMessage = postToNode;
  globalThis.AeonSage.sendUserAction = sendUserAction;
  globalThis.aeonsagePostMessage = postToNode;
  globalThis.aeonsageSendUserAction = sendUserAction;
  globalThis.aeonsagePostMessage = postToNode;
  globalThis.aeonsageSendUserAction = sendUserAction;
...
export async function handleA2uiHttpRequest(
  ...
  // Gateway token authentication for Canvas/A2UI routes.
  if (opts?.auth) {
    const { getBearerToken } = await import("../gateway/http-utils.js");
