...
if [[ -z "$version_content" ]]; then
  echo "<h2>AeonSage $VERSION</h2>"
  echo "<p>Latest AeonSage update.</p>"
  echo "<p><a href=\"https://github.com/aeonsage/aeonsage/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
