...
function resolveExecConfig(cfg: AeonSageConfig | undefined) {
...
export function createAeonSageCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createAeonSageReadTool(freshReadTool)];
    }
