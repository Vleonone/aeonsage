...
/**
 * MCP-style tool definition using inputSchema/call format.
 * These tools need to be adapted to AeonSage format using adaptMcpTool().
 */
export interface McpStyleTool {
  name: string;
  description: string;
  inputSchema: {
    type: "object";
