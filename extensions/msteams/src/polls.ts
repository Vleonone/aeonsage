...
export function extractMSTeamsPollVote(
  ...
  const pollId =
    readNestedString(value, ["aeonsagePollId"]) ??
    readNestedString(value, ["pollId"]) ??
    readNestedString(value, ["aeonsage", "pollId"]) ??
    readNestedString(value, ["aeonsage", "poll", "id"]) ??
    readNestedString(value, ["data", "aeonsagePollId"]) ??
    readNestedString(value, ["data", "pollId"]) ??
    readNestedString(value, ["data", "aeonsage", "pollId"]);
    ...
    actions: [
      {
        ...
        title: "Vote",
        data: {
          aeonsagePollId: pollId,
        },
        msteams: {
          type: "messageBack",
          text: "aeonsage poll vote",
          displayText: "Vote recorded",
          value: { aeonsagePollId: pollId },
        },
      },
    ],
  };
