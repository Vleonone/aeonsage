...
describe("createAeonSageCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createAeonSageCodingTools({
      config,
    ...
    const anthropicTools = createAeonSageCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createAeonSageCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createAeonSageCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
