...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "aeonsage-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveAeonSagePackageRoot } = await import("./aeonsage-root.js");
    ...
    vi.mocked(resolveAeonSagePackageRoot).mockResolvedValue("/opt/aeonsage");
