...
Nostr DM channel plugin for AeonSage using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to AeonSage. It enables your bot to:
...
# Configure aeonsage to use local relay
