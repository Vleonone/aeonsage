...
${formatHelpExamples([
          ['aeonsage message send --target +18888888888 --message "Hi"', "Send a text message."],
          [
            'aeonsage message send --target +18888888888 --message "Hi" --media photo.jpg',
          ...
          [
            'aeonsage message react --channel discord --target 123 --message-id 456 --emoji "✓',
            "React to a message.",
          ],
        ])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.aeonsage.org/cli/message")}`,
    )
    .action(() => {
