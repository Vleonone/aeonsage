...
import { printInstitutionalHeader } from "../terminal/header.js";
...
export function summarizeExistingConfig(config: AeonSageConfig): string {
  const rows: string[] = [];
...
export function printWizardHeader(runtime: RuntimeEnv) {
  printInstitutionalHeader((msg) => runtime.log(msg));
}
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.aeonsage.org/gateway/remote",
    "https://docs.aeonsage.org/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
