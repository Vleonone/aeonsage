...
# Output:
# - dist/AeonSage.app
# - dist/AeonSage-<version>.zip
# - dist/AeonSage-<version>.dmg
...
APP="$ROOT_DIR/dist/AeonSage.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/AeonSage-$VERSION.zip"
DMG="$ROOT_DIR/dist/AeonSage-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/AeonSage-$VERSION.notary.zip"
