...
export type ChannelAgentToolFactory = (params: { cfg?: AeonSageConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AeonSageConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: AeonSageConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: AeonSageConfig }) => boolean;
  supportsCards?: (params: { cfg: AeonSageConfig }) => boolean;
