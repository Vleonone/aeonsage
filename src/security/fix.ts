...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AeonSageConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AeonSageConfig; env: NodeJS.ProcessEnv }): {
  cfg: AeonSageConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
