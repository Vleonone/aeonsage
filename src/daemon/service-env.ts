...
export function buildServiceEnvironment(params: {
  ...
  const profile = env.AEONSAGE_PROFILE;
  ...
  return {
    ...
    AEONSAGE_PROFILE: profile,
    AEONSAGE_STATE_DIR: env.AEONSAGE_STATE_DIR,
    AEONSAGE_CONFIG_PATH: env.AEONSAGE_CONFIG_PATH,
    AEONSAGE_GATEWAY_PORT: String(port),
    AEONSAGE_GATEWAY_TOKEN: token,
    AEONSAGE_LAUNCHD_LABEL: resolvedLaunchdLabel,
    AEONSAGE_SYSTEMD_UNIT: systemdUnit,
    AEONSAGE_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    AEONSAGE_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    AEONSAGE_STATE_DIR: env.AEONSAGE_STATE_DIR,
    AEONSAGE_CONFIG_PATH: env.AEONSAGE_CONFIG_PATH,
    AEONSAGE_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    AEONSAGE_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    AEONSAGE_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    AEONSAGE_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    AEONSAGE_LOG_PREFIX: "node",
    AEONSAGE_SERVICE_MARKER: NODE_SERVICE_MARKER,
    AEONSAGE_SERVICE_KIND: NODE_SERVICE_KIND,
    AEONSAGE_SERVICE_VERSION: VERSION,
  };
}
